...
/**
 * Borra TODO el historial mes a mes de pagos de deuda (`debt_payments`) del
 * espacio. Las deudas (saldos, estados) NO se tocan. El rollover mensual
 * volverá a registrar pagos de acá en adelante.
 */
